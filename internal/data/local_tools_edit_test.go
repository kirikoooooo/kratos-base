...
func setupLocalToolsTest(t *testing.T) (*localToolRuntime, context.Context, string) {
	t.Helper()
	...
	tools.root = dir
	ctx := withTaskAgent(withTaskID(context.Background(), "edit-tool-task"), biz.TaskAgentDefault)
